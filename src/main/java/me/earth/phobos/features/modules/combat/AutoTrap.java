...
public class AutoTrap extends Module {
    ...
    private final Setting<Boolean> antiSelf = register(new Setting("AntiSelf", false));
    ...
    private void placeList(List<Vec3d> list) {
        ...
        for(Vec3d vec3d : list) {
            ...
            if(entityCheck.getValue() && placeability == 1 && ((switchMode.getValue() == InventoryUtil.Switch.SILENT || (retries.get(position) == null || retries.get(position) < retryer.getValue())))) {
                placeBlock(position);
